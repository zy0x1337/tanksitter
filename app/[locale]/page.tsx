    ...
    <div className="min-h-screen bg-background font-sans selection:bg-blue-100">
      ...
      <nav className="fixed w-full z-50 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground tracking-tight">TankSitter</span>
          </div>
          <div className="flex items-center gap-4">
            <LanguageSwitcher />
            <ModeToggle />
            <Link href="/login">
              <Button variant="ghost" className="font-medium text-foreground">Login</Button>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <main className="pt-32 pb-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm font-medium mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            <Link href="/login" className="w-full sm:w-auto">
              <Button size="lg" className="w-full h-14 text-lg bg-blue-600 hover:bg-blue-700 text-white shadow-xl shadow-blue-500/20 rounded-2xl">
                {t('start_button')}
              </Button>
            </Link>
          </div>
        ...
        {/* Mockup / Demo Section */}
        <div className="max-w-sm mx-auto bg-card rounded-[2.5rem] shadow-2xl border-8 border-slate-900 overflow-hidden relative transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500 mb-24">
          ...
          <div className="p-4 space-y-4 bg-slate-50 min-h-[400px]">
            {/* Mockup bleibt hell (Simulation Sitter View) oder kann auch Darkmode haben */}
            ...
            <div className="bg-white p-0 rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
              ...
              <div className="p-4">
                ...
                <Button className="w-full bg-blue-600 h-10 text-sm rounded-xl text-white">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="bg-card p-6 rounded-2xl shadow-sm border border-border flex flex-col items-center text-center hover:-translate-y-1 transition-transform">
      ...
      <footer className="border-t border-border py-12 bg-background text-center">
        <p className="text-muted-foreground text-sm">
          Built with 💙 for the r/shrimptank community.
        </p>
        <div className="flex justify-center gap-6 text-xs text-muted-foreground mt-4">
            <Link href="/legal/imprint" className="hover:text-foreground">Imprint</Link>
